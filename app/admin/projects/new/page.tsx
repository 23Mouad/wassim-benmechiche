  ...
  return (
    <Card>
      <CardContent className="pt-6">
        <h1 className="text-2xl font-semibold text-gray-900 mb-6">Add New Project</h1>
              ...
              {images.map((image, index) => (
                <div key={index} className="relative group">
                  <div className="relative aspect-video rounded-lg overflow-hidden">
                    <Image src={image.preview || "/placeholder.svg"} alt="Preview" fill className="object-cover" />
                  </div>
                  <div className="absolute inset-0 flex items-center justify-center gap-2 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value={index.toString()} id={`primary-${index}`} className="bg-white" />
                        <Label htmlFor={`primary-${index}`} className="text-white">
                          Primary
                        </Label>
                      </div>
                    </RadioGroup>
